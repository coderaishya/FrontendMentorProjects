...
function updateCurrentUserToLS(updatedCurrentUser) {
    data.currentUser.image.png = `images/avatars/image-${updatedCurrentUser}.png`;
    data.currentUser.image.webp = `images/avatars/image-${updatedCurrentUser}.webp`;
...
function nonCurrentUserReply(response) {
    const nonCurrentUser = `
        <button class="reply-icon-button" aria-label="Reply to Comment">
            <img class="icon-reply" src="images/icon-reply.svg" alt="Reply f-eIcon">Reply
        </button>
...
function currentUserReply(response) {
    const currentUser = `
        <div id="delete-or-edit-button-grp">
            <button class="delete-button" aria-label="Delete Comment"><img class="icon-delete" src="images/icon-delete.svg" alt="Delete Icon">Delete</button>
            <button class="edit-button" aria-label="Edit to Comment"><img class="icon-edit" src="images/icon-edit.svg" alt="Edit Icon">Edit</button>
        </div>
...
function createUserToResponseElement(response) {
    ...
    newResponseElement.innerHTML = `
        <form class="add-form" id="add-${response}-form">
            <picture>
                <source srcset="images/avatars/image-${currentUsername}.webp" type="image/webp">
                <img class="user-avatar current" src="images/avatars/image-${currentUsername}.png" alt="User Avatar">
            </picture>  
